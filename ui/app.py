...
st.text("A lightweight backtesting tool that evaluates your trading strategies using historical close prices.")

be = BacktestingEngine()
today = datetime.today().date()

selected_label = st.selectbox("Search by Ticker or Company Name", list(be.get_tickets().keys()))
